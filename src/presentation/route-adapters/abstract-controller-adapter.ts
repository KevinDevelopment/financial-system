...
export abstract class AbstractControllerAdapter<TController> {
    ...
    protected abstract executeController(httpRequest: HttpRequest): Promise<HttpResponse>;
    ...
    protected async sendResponse(reply: FastifyReply, httpResponse: HttpResponse): Promise<void> {
